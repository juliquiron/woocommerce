...
class WC_Frontend_Scripts {
	...
	private static function register_scripts() {
		...
		$register_scripts = apply_filter( 'woocommerce_register_scripts', $register_scripts );
		foreach ( $register_scripts as $name => $props ) {
			self::register_script( $name, $props['src'], $props['deps'], $props['version'], $props['in_footer'] );
		}
	}
